package com.meijsoft.cameraadvance.remotecontrol;
...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "net.sourceforge.com.meij.cameraadvance.Remotecontrol.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "net.sourceforge.com.meij.cameraadvance.Remotecontrol.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "net.sourceforge.com.meij.cameraadvance.Remotecontrol.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "net.sourceforge.com.meij.cameraadvance.Remotecontrol.ACTION_DATA_AVAILABLE";
    public final static String ACTION_REMOTE_COMMAND =
            "net.sourceforge.com.meij.cameraadvance.Remotecontrol.COMMAND";
    public final static String ACTION_SENSOR_VALUE =
            "net.sourceforge.com.meij.cameraadvance.Remotecontrol.SENSOR";
    public final static String SENSOR_TEMPERATURE =
            "net.sourceforge.com.meij.cameraadvance.Remotecontrol.TEMPERATURE";
    public final static String SENSOR_DEPTH =
            "net.sourceforge.com.meij.cameraadvance.Remotecontrol.DEPTH";
    public final static String EXTRA_DATA =
            "net.sourceforge.com.meij.cameraadvance.Remotecontrol.EXTRA_DATA";

...
import com.meijsoft.cameraadvance.ui.ArraySeekBarPreference;
...
public class PreferenceSubPhoto extends PreferenceSubScreen {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.P) {
            ListPreference pref = (ListPreference)findPreference("preference_image_format");
            pref.setEntries(R.array.preference_image_format_entries_noheic);
            pref.setEntryValues(R.array.preference_image_format_values_noheic);
        }

...
public class InstrumentedTest {
    ...
    private void switchToISO(int required_iso) {
        ...
        if( iso != required_iso ) {
            mActivityRule.getScenario().onActivity(activity -> {
                ...
                View exposureContainer = activity.findViewById(com.meijsoft.cameraadvance.R.id.exposure_container);
    ...
    public void testTakePhotoManualISOExposurePostCapture() throws InterruptedException {
        ...
        mActivityRule.getScenario().onActivity(activity -> {
            // open exposure UI
            View exposureButton = activity.findViewById(com.meijsoft.cameraadvance.R.id.exposure);
            View exposureContainer = activity.findViewById(com.meijsoft.cameraadvance.R.id.manual_exposure_container);
        ...
        mActivityRule.getScenario().onActivity(activity -> {
            View exposureButton = activity.findViewById(com.meijsoft.cameraadvance.R.id.exposure);
            View exposureContainer = activity.findViewById(com.meijsoft.cameraadvance.R.id.manual_exposure_container);
            SeekBar isoSeekBar = activity.findViewById(com.meijsoft.cameraadvance.R.id.iso_seekbar);
            SeekBar exposureTimeSeekBar = activity.findViewById(com.meijsoft.cameraadvance.R.id.exposure_time_seekbar);
            assertEquals(exposureButton.getVisibility(), View.VISIBLE);
            assertEquals(exposureContainer.getVisibility(), View.VISIBLE);
    ...
    public void testSettingsSlowPreviewStart() throws InterruptedException {
        ...
        mActivityRule.getScenario().onActivity(activity -> {
            View settingsButton = activity.findViewById(com.meijsoft.cameraadvance.R.id.settings);
